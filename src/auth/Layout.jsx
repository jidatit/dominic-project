...
const Layout = () => {
    ...
    return (
        <div className='w-full relative min-h-screen flex flex-col justify-center items-center bg-[#6D00F8]'>
            <Link to="/">
            ...
            {currentUser ? (
                desiredDestination ? handleNavigation(desiredDestination) : <Navigate to="/" />
            ) : (
                <>
                    <Outlet />
                </>
