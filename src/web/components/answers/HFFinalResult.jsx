            ...
            {user ? (
                <div id="result-content" className="w-full h-auto flex flex-col gap-8 border-t-2 border-gray-300 py-8">
                    ...
                    <div className="w-full flex lg:flex-row flex-col justify-evenly items-center gap-2 lg:px-44 px-8">
                        <button onClick={handlePrint} className="lg:w-auto w-full flex flex-row justify-center items-center gap-2 py-3 px-6 bg-[#6D00F8] text-white cursor-pointer rounded-md">
                            <p className="text-sm lg:text-lg font-bold"> Print </p>
                            <PrintIcon />
                        </button>
                        <button onClick={handleSaveAsPDF} className="lg:w-auto w-full flex flex-row justify-center items-center gap-2 py-3 px-6 bg-[#6D00F8] text-white cursor-pointer rounded-md">
