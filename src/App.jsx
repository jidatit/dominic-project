  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-[#1F2634] bg-opacity-75">
        <div className='w-[654px] h-[310px] rounded-lg mt-[40px] flex flex-col gap-[23px] justify-center items-center' style={{ background: "linear-gradient(to right, #ffffff,#fffff8)" }}>
          <p className='font-semibold text-black text-2xl text-center'>Are you sure you want to logout?</p>
          <div className='w-[540px] h-[70px] flex flex-row gap-6 justify-center'>
            {signupType === "admin" ? (<button onClick={() => { navigate('/admin_portal') }} className='bg-[#a8222b] rounded-md w-[220px] h-[50px] font-bold text-white'>Cancel</button>)
              : (<button onClick={() => { navigate('/') }} className='bg-[#a4262e] rounded-md w-[220px] h-[50px] font-bold text-white'>Cancel</button>)}
            {signupType === "admin" ? (<button onClick={logout} className='bg-[#6D00F8] rounded-md w-[220px] h-[50px] font-bold text-white'>Confirm</button>)
              : (<button onClick={handleLogout} className='bg-[#6D00F8] rounded-md w-[220px] h-[50px] font-bold text-white'>Confirm</button>)}
          </div>
        </div>
      </div>
    </>
