...
const SideNav = () => {
	const menus = [
		...
		{
			name: "Questions",
			link: "/admin_portal/questions",
			icon: BsQuestionSquare,
		},
		{ name: "Users", link: "/admin_portal", icon: FaUser },
		{
			name: "Responses",
			link: "/admin_portal/admin_response",
			icon: RiSurveyLine,
		},
	...
	return (
		<section className="flex">
			<div
				className={` bg-[#6D00F8] min-h-screen shadow-md ${
					open ? "w-68" : " w-14 lg:w-[75px]"
				} duration-500 text-gray-100 px-2 lg:px-4 py-1 sm:py-2 md:py-2 lg:py-4 xl:py-6 2xl:py-6`}
			>
				<div className="py-3 flex justify-center items-center">
					{open && (
						<img
							className="cursor-pointer unselectable w-[200px]"
						...
						<Link
							...
							className={`group flex items-center text-base gap-2 font-poppins ${
								...
								location.pathname === menu?.link
									? "bg-[rgba(112,127,221,0.1) text-[#ffffff] bg-[#4179d1] rounded-md"
									: "text-white"
